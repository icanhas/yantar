...
#define SVF_CLIENTMASK		0x00000002	/* XXX */
...
typedef enum {
	...
	G_PRINT,			/* print message on the local console */
	G_ERROR,			/* abort the game */
	/* 
	...
	G_ARGC,
	G_ARGV,			/* ClientCommand and ServerCommand parameter access */
	G_FS_FOPEN_FILE,
	G_FS_READ,
	G_FS_WRITE,
	G_FS_FCLOSE_FILE,
	 ...
	 */
	G_LOCATE_GAME_DATA,
	G_DROP_CLIENT,		/* kick a client off the server with a message */
	/* 
	...
	G_GET_SERVERINFO,
	G_SET_BRUSH_MODEL,	/* sets mins and maxs based on the brushmodel name */

	G_TRACE,				/* collision detection against all linked entities */
	G_POINT_CONTENTS,	/* point contents against all linked entities */
	G_IN_PVS,
	 ...
	 */
	G_LINKENTITY,
	G_UNLINKENTITY,		/* call before removing an interactive entity */
	/* 
	 * EntitiesInBox will return brush models based on their bounding box,
	 * so exact determination must still be done with EntityContact 
	 */
	G_ENTITIES_IN_BOX,
	G_ENTITY_CONTACT,	/* perform an exact check against inline brush models of non-square shape */
...
typedef enum {
	 ...
	 * The game should call G_GET_ENTITY_TOKEN to parse all the
