...
void	sndstartsound(Vec3 origin, int entnum, int entchannel, Handle sfx);
void	sndstartlocalsound(Handle sfx, int channelNum);
 ...
 */
Handle	sndregister(const char *sample, qbool compressed);
