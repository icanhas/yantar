...
void
Matrix16Copy(const matrix_t in, matrix_t out)
{
...
void
Matrix16Multiply(const matrix_t in1, const matrix_t in2, matrix_t out)
{
...
void
Matrix16Transform(const matrix_t in1, const vec4_t in2, vec4_t out)
{
	out[ 0] = in1[ 0] * in2[ 0] + in1[ 4] * in2[ 1] + in1[ 8] * in2[ 2] + in1[12] * in2[ 3];
	out[ 1] = in1[ 1] * in2[ 0] + in1[ 5] * in2[ 1] + in1[ 9] * in2[ 2] + in1[13] * in2[ 3];
	out[ 2] = in1[ 2] * in2[ 0] + in1[ 6] * in2[ 1] + in1[10] * in2[ 2] + in1[14] * in2[ 3];
...
void
Matrix16Dump(const matrix_t in)
{
...
void
Matrix16Translation(vec3_t vec, matrix_t out)
{
...
void
Matrix16Ortho(float left, float right, float bottom, float top, float znear, float zfar, matrix_t out)
{
	Matrix16Zero(out);
...
void
VectorLerp(vec3_t a, vec3_t b, float lerp, vec3_t c)
{
