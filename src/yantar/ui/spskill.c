...
#define ART_BACK		Pmenuart "/back_0.tga"
#define ART_BACK_FOCUS		Pmenuart "/back_1.tga"
#define ART_FIGHT		Pmenuart "/fight_0"
#define ART_FIGHT_FOCUS		Pmenuart "/fight_1"
...
UI_SPSkillMenu_Cache(void)
{
	...
	skillMenuInfo.skillpics[0] = trap_R_RegisterShaderNoMip(
		ART_MAP_COMPLETE1);
	skillMenuInfo.skillpics[1] = trap_R_RegisterShaderNoMip(
		ART_MAP_COMPLETE2);
	skillMenuInfo.skillpics[2] = trap_R_RegisterShaderNoMip(
		ART_MAP_COMPLETE3);
	skillMenuInfo.skillpics[3] = trap_R_RegisterShaderNoMip(
		ART_MAP_COMPLETE4);
...
UI_SPSkillMenu_Init(void)
{
	...
	skill = (int)Q_clamp(1, 5, trap_Cvar_VariableValue("g_spSkill"));
	SetSkillColor(skill, color_white);
	skillMenuInfo.art_skillPic.shader = skillMenuInfo.skillpics[skill - 1];
	if(skill == 5)
		trap_S_StartLocalSound(skillMenuInfo.nightmareSound,
