...
Preferences_MenuInit(void)
{
	...
	s_preferences.crosshair.generic.flags	= QMF_PULSEIFFOCUS|
						  QMF_SMALLFONT|
						  QMF_NODEFAULTINIT|
						  QMF_OWNERDRAW;
	...
	s_preferences.dynamiclights.generic.flags	= QMF_PULSEIFFOCUS|
							  QMF_SMALLFONT;
	...
	s_preferences.identifytarget.generic.flags	= QMF_PULSEIFFOCUS|
							  QMF_SMALLFONT;
	...
	s_preferences.highqualitysky.generic.flags	= QMF_PULSEIFFOCUS|
							  QMF_SMALLFONT;
	...
	s_preferences.synceveryframe.generic.flags	= QMF_PULSEIFFOCUS|
							  QMF_SMALLFONT;
	...
	s_preferences.drawteamoverlay.generic.flags	= QMF_PULSEIFFOCUS|
							  QMF_SMALLFONT;
	...
	s_preferences.allowdownload.generic.flags = QMF_PULSEIFFOCUS|
						    QMF_SMALLFONT;
...
Preferences_Cache(void)
{
	...
	for(n = 0; n < NUM_CROSSHAIRS; n++)
		s_preferences.crosshairShader[n] = trap_R_RegisterShaderNoMip(va(Pxhairs "/crosshair%d", n+1));
}
