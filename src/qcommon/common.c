...
/* Q_TouchMemory: Touch all known used data to make sure it is paged in */
void
Q_TouchMemory(void)
{
	int	start, end;
...
Q_InitZoneMemory(void)
{
	 ...
	 * not in q3config.cfg or Q_StartupVariable, as they haven't been
