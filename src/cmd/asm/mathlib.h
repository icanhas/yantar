...
vec_t _Vec3Dot(vec3_t v1, vec3_t v2);
void _Vec3Sub(vec3_t va, vec3_t vb, vec3_t out);
void _Vec3Add(vec3_t va, vec3_t vb, vec3_t out);
void _Vec3Copy(vec3_t in, vec3_t out);
void _VectorScale(vec3_t v, vec_t scale, vec3_t out);

double Vec3Len(const vec3_t v);

void Vec3MA(const vec3_t va, double scale, const vec3_t vb, vec3_t vc);

void Vec3Cross(const vec3_t v1, const vec3_t v2, vec3_t cross);
vec_t Vec3Normalize(const vec3_t in, vec3_t out);
