...
R_CullSurface(surfaceType_t *surface, material_t *shader)
{
	...
	d = dotv3 (tr.or.viewOrigin, sface->plane.normal);
...
static int
R_DlightFace(srfSurfaceFace_t *face, int dlightBits)
{
	float	d;
	int	i;
	dlight_t *dl;
	...
	for(i = 0; i < tr.refdef.num_dlights; i++){
		...
		d	= dotv3(dl->origin, face->plane.normal) - face->plane.dist;
...
static int
R_DlightGrid(srfGridMesh_t *grid, int dlightBits)
{
	int i;
	dlight_t *dl;
...
static int
R_DlightTrisurf(srfTriangles_t *surf, int dlightBits)
{
