...
#define SPECIFYSERVER_FRAMEL	Pmenuart "/frame2_l"
#define SPECIFYSERVER_FRAMER	Pmenuart "/frame1_r"
#define SPECIFYSERVER_BACK0	Pmenuart "/back_0"
#define SPECIFYSERVER_BACK1	Pmenuart "/back_1"
#define SPECIFYSERVER_FIGHT0	Pmenuart "/fight_0"
#define SPECIFYSERVER_FIGHT1	Pmenuart "/fight_1"
...
SpecifyServer_MenuInit(void)
{
	...
	s_specifyserver.port.generic.flags	= QMF_PULSEIFFOCUS|
						  QMF_SMALLFONT|
						  QMF_NUMBERSONLY;
