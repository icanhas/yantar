...
qboolean        G_SpawnFloat(const char *key, const char *defaultString,
			     float *out);
...
int             trap_FS_FOpenFile(const char *qpath, fileHandle_t *f,
				  fsMode_t mode);
...
int             trap_BotNextConsoleMessage(
	int chatstate, void /* struct bot_consolemessage_s */ *cm);
